...
" Pathogen {{{
    ...
    "call add(g:pathogen_disabled, 'jshint2.vim')
    ...
    "call add(g:pathogen_disabled, 'nerdtree-visual-selection')
    "call add(g:pathogen_disabled, 'obsession.vim')
    "call add(g:pathogen_disabled, 'pathogen')
    "call add(g:pathogen_disabled, 'pgsql.vim')
    ...
    "call add(g:pathogen_disabled, 'vim-autosave')
    ...
    "call add(g:pathogen_disabled, 'vimport')
